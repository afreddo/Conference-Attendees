...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:Helloworld123@localhost/conference'
...
def Index():
    ...
    return render_template("index.html", attendees=all_data)
...
def insert():
    ...
    if request.method == 'POST':
        ...
        flash("Attendee Inserted Successfully")
